...
import pic from "../assets/kag.png"
...
export const About=()=>{ 
    ...
    const toCopy=()=>{
      ...
      setTimeout(()=>{ setIsClipBoard(false)}
      ,3000)
           ...
           <div className={cl.box} style={{background:"#28292c"}}>
            <div className={cl.call}>
               ...
               <h3 className={cl.text2}>
                  at my e-mail-<span className={cl.email}>@sadikovinsaf99@gmail.com</span>
                </h3>
              ...
              <div className={cl.media}>
                   ...
                   <a className={cl.ic}>
                        <img className={cl.ic} onClick={toCopy}src={SM[0].img}>
                    ...
                    <a className={cl.ic} target="_blank" href={SM[1].link}>
                        <img className={cl.ic} src={SM[1].img}>
              ...
              <div className={isClipBoard?cl.clip:cl.clip_passive}>
                <p className={cl.clip_text}>{SM[0].link} is copied to the clipboard</p>

              </div>

             </div>
                <div className={cl.curve_box} style={{background:theme?"hsl(164, 61%, 65%)":"rgb(119, 64, 105)"}}>
                   
                    <img className={cl.pic} src={pic}>
                    </img>
